    ...
    public class IdentityLocalizedErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = localizer["User name '{0}' is invalid, can only contain letters or digits.", userName]
            };
        }
        public override IdentityError InvalidEmail(string email)
        {
            return new IdentityError
            {
                ...
                Description = localizer["Email '{0}' is invalid.", email]
            };
        }
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = localizer["User Name '{0}' is already taken.", userName]
            };
        }
        ...
        public override IdentityError InvalidRoleName(string role)
        {
            return new IdentityError
            {
                ...
                Description = localizer["Role name '{0}' is invalid.", role]
            };
        }
